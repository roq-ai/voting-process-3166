...
import { getVoteById } from 'apiSdk/votes';
import { VoteInterface } from 'interfaces/vote';
import { VotingResultListPage } from 'pages/voting-results';

function VoteViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('vote', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/votes/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Option 5" text={data?.option_5} />
