  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Voting Process - Empowering every voice in the school. Make your choice from five options and witness the collective decision in real-time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzY2hvb2x8ZW58MHx8fHwxNjk0MzYwNzU0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Voting Process - Empowering every voice in the school. Make your choice from five options and witness the collective decision in real-time.`}
            </Text>
            <Box
